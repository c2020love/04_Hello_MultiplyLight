...
int main()
{
    ...
    Shader lightShader("D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\shader\\lightvertex.glsl", "D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\shader\\lightfragment.glsl");
    Shader cubeShader("D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\shader\\cubevertex.glsl", "D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\shader\\cubefragement.glsl");
    //@创建vbo顶点缓冲对象来储存大量顶点
...
一个是管理顶点信息*/
    ...
    */
    char *str1 = "D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\sources\\wood.png";
    char *str2 = "D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\sources\\iron.png";
    char *str3 = "D:\\opengl\\code\\RayCode\\04_Hello_MultiplyLight\\src\\sources\\zuiyou.jpg";
    ...
    while (!glfwWindowShouldClose(window)) //检查用户是否需要退出
    {
        ...
        cubeShader.use();
        cubeShader.setVec3("dirLight.direction", -0.2f , -1.0f , -3.0f);
        cubeShader.setVec3("dirLight.ambient", 0.1f , 0.1f , 0.1f);
        cubeShader.setVec3("dirLight.diffuse", 0.4f , 0.4f , 0.4f);
        cubeShader.setVec3("dirLight.specular" , 0.5f , 0.5f , 0.5f);

        cubeShader.setVec3("pointLights[0].position" , pointLightPositions[0]);
        cubeShader.setVec3("pointLights[0].ambient" , 0.1f , 0.1f , 0.1f);
        ...
        cubeShader.setVec3("pointLights[1].ambient" , 0.1f , 0.1f , 0.1f);
        ...
        cubeShader.setVec3("pointLights[2].ambient" , 0.1f , 0.1f , 0.1f);
        ...
        cubeShader.setVec3("pointLights[3].ambient" , 0.1f , 0.1f , 0.1f);
        ...
        cubeShader.setFloat("spotLight.cutOff", glm::cos(glm::radians(12.5f))); //给cutoff一个余弦值，好用来比较那两个角度的大小
        ...
        cubeShader.setVec3("spotLight.diffuse", 0.8f, 0.8f, 0.8f); // 将光照调暗了一些以搭配场景
